    ...
    <header className="fixed inset-x-0 top-0 z-50">
     <nav className="mx-auto flex max-w-6xl flex-col items-center gap-2 px-2 py-3 md:h-20 md:flex-row md:justify-between md:px-8 md:py-0">
       ...
       <div className="flex rounded-full border border-white/60 bg-white/65 px-1 py-1 shadow backdrop-blur-xl sm:px-1.5 md:px-2 lg:px-3 lg:py-2">
          <NavigationMenu>
            <NavigationMenuList className="flex items-center gap-0 lg:gap-1 md:gap-0.5">
              ...
              <NavigationMenuItem>
                <NavigationMenuLink
                  href="#contact"
                  className="hidden sm:block rounded-full px-5 py-2.5 text-sm font-medium text-foreground/70 transition-all hover:bg-[#31543f] hover:text-white"
                >
                  Contact
                </NavigationMenuLink>
              </NavigationMenuItem>
